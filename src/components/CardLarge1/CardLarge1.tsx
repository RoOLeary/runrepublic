...
const CardLarge1: FC<CardLarge1Props> = ({
  ...
  return (
    <div
      className={`CardLarge1 CardLarge1--hasAnimation relative flex flex-col-reverse md:flex-row justify-end ${className}`}
    >
      ...
      <div className="w-full md:w-4/5 lg:w-2/3">
        <Link href={href} className="CardLarge1__right block relative">
          <NcImage
